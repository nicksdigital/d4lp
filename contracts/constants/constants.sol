...
// Social action types
bytes32 constant ACTION_POST = keccak256("POST");
bytes32 constant ACTION_COMMENT = keccak256("COMMENT");
bytes32 constant ACTION_SHARE = keccak256("SHARE");
bytes32 constant ACTION_LIKE = keccak256("LIKE");

// Base points for actions
uint16 constant POINTS_POST = 100;
uint16 constant POINTS_COMMENT = 50;
uint16 constant POINTS_SHARE = 75;
uint16 constant POINTS_LIKE = 25;

// Time constants
uint32 constant DAILY_RESET = 24 hours;
uint32 constant WEEKLY_RESET = 7 days;
uint32 constant MONTHLY_RESET = 30 days; 
